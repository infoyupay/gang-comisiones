...
/**
 * Supplier for {@link ManageConceptController} that wires the default {@link AppContext}
 * and the default {@link UseCaseControllerRegistry}.
 *
 * @author InfoYupay SACS
 * @version 1.0
 */
public class ManageConceptControllerSupplier implements UseCaseSupplier<ManageConceptController> {
    @Override
